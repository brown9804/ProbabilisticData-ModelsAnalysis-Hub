...
# 10.000 bits, a raíz del cual se quiere simular una transmisión de datos
# por un canal el cual se considera ruidoso. Esto sucede a 5000 Hz y a un
# periodo completo de igual magnitud al de la ondan portadora.
